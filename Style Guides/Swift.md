...
For setters and getters, if its only 1 line of changes set and get everything on one line. If its multiple lines break everything up like you would a class, with enters for the opening and closing brackets.

For functions and init methods, prefer named parameters for all arguments unless the context is very clear. Include external parameter names if it makes function calls more readable.

Always put setter/getters at the BOTTOM most part of the file.
...
```swift
//for multi line
var touchCallback:((K_EditImage)->Void)
{
    set
    {
